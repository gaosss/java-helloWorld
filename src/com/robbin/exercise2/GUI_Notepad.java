...
import javax.swing.*;
public class GUI_Notepad extends JFrame{
	...
	JMenuItem
	eitem1,eitem2,eitem3,eitem4,eitem5,eitem6,eitem7,eitem8,eitem9,eitem10,eitem11;
	//格式组定义组件
	...
	public static void main(String[] args) {
		GUI_Notepad win=new GUI_Notepad();
	}
	...
	public GUI_Notepad(){
		...
		item2.setMnemonic('O');
		item2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,InputEvent.CTRL_MASK));//设置ctrl 快捷组合键
